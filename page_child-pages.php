...
function human_droid_display_child_pages_menu() {
  $childpages = get_pages( array( 'child_of' => wp_get_post_parent_id( get_the_ID() ) ) );

  if(count($childpages) > 1) {
    echo '<div class="uk-button-group" style="width:100%;">';
    $width = 100.0 / count($childpages);
    foreach( $childpages as $page ) {
      $page_class = "primary-ghost-buton";
      if( $page->ID ==  get_the_ID() ) {
        $page_class = "primary-ghost-buton primary-ghost-buton-active";
      }
  	?>
